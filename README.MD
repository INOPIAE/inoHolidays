...
### Ribbon
In the tab Formulas ther is a group inoHolidays which contains these buttons:

* Import Holidays - Adds a list of all public holidays for a given year and country
